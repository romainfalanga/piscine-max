...
const Q = [
  ...
  // ============================================================
  // ÉQUIPEMENTS & HYDRAULIQUE (pompes, vannes, vanne multivoies, circuit)
  // — questions issues des fiches matériel vérifiées
  // ============================================================
  { cat: 'Équipements & hydraulique', q: "Pourquoi une pompe de filtration piscine est-elle dite « auto-amorçante » ?", a: "Elle démarre toute seule à heure fixe", b: "Son préfiltre garde une réserve d'eau qui lui permet de se réamorcer", c: "Elle n'a pas besoin d'électricité", d: "Elle aspire l'air aussi bien que l'eau", correct: 'b', exp: "Le préfiltre rempli d'eau sert de réserve d'amorçage : c'est aussi pour ça qu'on le remplit manuellement après une intervention." },
  { cat: 'Équipements & hydraulique', q: "Quel est le rôle du diffuseur dans une pompe centrifuge ?", a: "Filtrer les débris", b: "Refroidir le moteur", c: "Convertir la vitesse de l'eau en pression et empêcher le retour du flux", d: "Doser le chlore", correct: 'c' },
  { cat: 'Équipements & hydraulique', q: "Que se passe-t-il si une pompe tourne à sec quelques minutes ?", a: "Rien, elle est prévue pour", b: "La garniture mécanique, lubrifiée par l'eau, est détruite", c: "Le condensateur explose", d: "Le débit augmente", correct: 'b' },
  { cat: 'Équipements & hydraulique', q: "Où le surpresseur d'un robot à pression prélève-t-il l'eau ?", a: "Directement dans le bassin", b: "Avant la pompe de filtration", c: "Après le filtre, pour la renvoyer sous pression vers la prise balai", d: "Dans le skimmer", correct: 'c' },
  { cat: 'Équipements & hydraulique', q: "Un surpresseur doit être asservi électriquement pour ne fonctionner que si :", a: "La pompe à chaleur est allumée", b: "La pompe de filtration tourne", c: "Le robot est sorti de l'eau", d: "Il fait jour", correct: 'b', exp: "Il aspire l'eau du circuit : sans filtration en marche, il tourne à sec et se détruit." },
  { cat: 'Équipements & hydraulique', q: "Quel débit vise-t-on pour une nage à contre-courant permettant de nager réellement ?", a: "5-10 m³/h", b: "15-20 m³/h", c: "50-60 m³/h", d: "200 m³/h", correct: 'c' },
  { cat: 'Équipements & hydraulique', q: "Sur une vanne 6 voies, la position « Circulation » fait passer l'eau :", a: "À travers le filtre puis à l'égout", b: "De la pompe directement aux refoulements, sans passer par le filtre", c: "À contre-courant dans le filtre", d: "Nulle part, tout est fermé", correct: 'b' },
  { cat: 'Équipements & hydraulique', q: "Quand utilise-t-on la position « Égout » (Waste) de la vanne 6 voies ?", a: "Pour la filtration quotidienne", b: "Pour aspirer une eau très chargée (algues, floculant) sans encrasser le filtre, ou baisser le niveau", c: "Uniquement en hiver", d: "Pour nettoyer les skimmers", correct: 'b' },
  { cat: 'Équipements & hydraulique', q: "À quoi sert la position « Rinçage » juste après un contre-lavage ?", a: "À rincer les canalisations du bassin", b: "À retasser le média filtrant et envoyer les résidus à l'égout au lieu du bassin", c: "À vider complètement le filtre", d: "Elle ne sert à rien", correct: 'b' },
  { cat: 'Équipements & hydraulique', q: "Quelle est la règle d'or absolue avant de manœuvrer une vanne multivoies ?", a: "Ouvrir le couvercle du préfiltre", b: "Mettre des gants", c: "Arrêter la pompe", d: "Fermer les skimmers", correct: 'c', exp: "Sous pression, le boisseau cisaille le joint étoile et le coup de bélier peut fissurer la vanne." },
  { cat: 'Équipements & hydraulique', q: "Pourquoi laisse-t-on la poignée de la vanne 6 voies entre deux crans (ou sur un cran « hivernage ») pendant l'hiver ?", a: "Pour laisser l'eau circuler", b: "Pour décoller le boisseau du joint étoile et éviter qu'il reste comprimé tout l'hiver", c: "Pour vidanger le bassin", d: "C'est une erreur, il ne faut jamais le faire", correct: 'b' },
  { cat: 'Équipements & hydraulique', q: "En position « Filtration », de l'eau s'écoule en continu vers l'égout. Quelle est la cause la plus probable ?", a: "Le niveau du bassin est trop haut", b: "Le joint étoile de la vanne multivoies est usé", c: "Le sable est trop vieux", d: "La pompe est trop puissante", correct: 'b' },
  { cat: 'Équipements & hydraulique', q: "Un by-pass complet (pour PAC, réchauffeur...) est constitué de :", a: "1 vanne", b: "2 vannes", c: "3 vannes (centrale + entrée + sortie)", d: "6 vannes", correct: 'c' },
  { cat: 'Équipements & hydraulique', q: "Sur un by-pass de PAC, fermer progressivement la vanne centrale a pour effet :", a: "De diminuer le débit dans la PAC", b: "D'augmenter le débit qui traverse la PAC", c: "D'arrêter la filtration", d: "De vider l'échangeur", correct: 'b' },
  { cat: 'Équipements & hydraulique', q: "Pourquoi faut-il vidanger l'échangeur de la PAC avant l'hiver ?", a: "Pour économiser l'eau", b: "Parce qu'un échangeur titane qui gèle est détruit", c: "Pour éviter les algues", d: "Ce n'est pas nécessaire", correct: 'b' },
  { cat: 'Équipements & hydraulique', q: "Quel est l'ordre correct des équipements dans le circuit hydraulique ?", a: "Pompe → traitement → filtre → chauffage", b: "Pompe → filtre → chauffage → traitement → refoulements", c: "Filtre → pompe → chauffage", d: "Traitement → filtre → pompe", correct: 'b', exp: "L'injection de traitement se fait toujours le plus en aval possible pour protéger les équipements de l'eau concentrée en produit." },
  { cat: 'Équipements & hydraulique', q: "Quelle répartition d'aspiration applique-t-on classiquement en saison ?", a: "100% bonde de fond", b: "Environ 2/3 skimmers et 1/3 bonde de fond", c: "100% skimmers", d: "50% prise balai", correct: 'b' },
  { cat: 'Équipements & hydraulique', q: "Parmi les rôles de la bonde de fond, on trouve :", a: "Chauffer l'eau du fond", b: "Aspirer l'eau la plus froide/chargée et sécuriser l'alimentation de la pompe si le niveau baisse", c: "Injecter le chlore", d: "Mesurer le pH", correct: 'b' },
  { cat: 'Équipements & hydraulique', q: "Un clapet anti-retour à l'aspiration sert notamment à :", a: "Augmenter le débit", b: "Maintenir l'amorçage quand la pompe est au-dessus du plan d'eau", c: "Filtrer les feuilles", d: "Réduire le bruit", correct: 'b' },
  { cat: 'Équipements & hydraulique', q: "Une vanne 3 voies type Jandy permet :", a: "De filtrer plus fin", b: "De répartir un flux entre deux directions (tout A, tout B ou mélange)", c: "De remplacer le filtre", d: "De chauffer l'eau", correct: 'b' },
  { cat: 'Équipements & hydraulique', q: "Pour limiter les pertes de charge, on préfère remplacer un coude 90° par :", a: "Deux coudes 45°", b: "Un bouchon", c: "Un coude 90° plus petit", d: "Un té", correct: 'a' },

  // ============================================================
  // FILTRATION (médias, finesses, backwash) — complément fiches matériel
  // ============================================================
  { cat: 'Filtration', q: "Quelle est la finesse de filtration d'un filtre à sable classique (sans floculant) ?", a: "2-5 microns", b: "30-40 microns", c: "100-200 microns", d: "1 mm", correct: 'b' },
  { cat: 'Filtration', q: "Quel système de filtration offre la meilleure finesse du marché (2-5 microns) ?", a: "Le filtre à sable", b: "Le filtre à cartouche", c: "Le filtre à diatomées", d: "Le filtre à poche 30 microns", correct: 'c' },
  { cat: 'Filtration', q: "Quel média filtrant adsorbe aussi l'ammonium, réduisant chloramines et odeur de chlore ?", a: "Le sable de silice", b: "La zéolite", c: "Le gravier", d: "Les balles filtrantes", correct: 'b' },
  { cat: 'Filtration', q: "Quelle est la finesse réelle d'un verre filtrant standard (hors verre activé haut de gamme) ?", a: "1-5 microns", b: "15-20 microns", c: "50-60 microns", d: "100 microns", correct: 'b', exp: "Les « 1-5 microns » des publicités correspondent au verre activé type AFM utilisé AVEC floculation." },
  { cat: 'Filtration', q: "Les poches filtrantes type Desjoyaux existent en finesses :", a: "6, 15 et 30 microns", b: "1, 2 et 3 microns", c: "50, 100 et 200 microns", d: "Une seule finesse universelle", correct: 'a' },
  { cat: 'Filtration', q: "À partir de quelle hausse de pression au manomètre déclenche-t-on un contre-lavage ?", a: "+0,05 bar", b: "+0,3 à +0,5 bar au-dessus de la pression de référence", c: "+2 bars", d: "On ne se fie jamais au manomètre", correct: 'b' },
  { cat: 'Filtration', q: "Combien de temps dure un contre-lavage correctement mené ?", a: "10 secondes", b: "2 à 3 minutes, jusqu'à ce que l'eau soit claire dans le voyant", c: "30 minutes minimum", d: "2 heures", correct: 'b' },
  { cat: 'Filtration', q: "Avec quel type de filtre le floculant est-il compatible ?", a: "Tous les filtres", b: "Uniquement le filtre à sable (ou verre)", c: "Uniquement la cartouche", d: "Uniquement les diatomées", correct: 'b', exp: "Le floculant colmate irrémédiablement cartouches, poches et diatomées." },
  { cat: 'Filtration', q: "Quelle est la vitesse de filtration maximale admise pour un filtre piscine ?", a: "5 m³/h/m²", b: "50 m³/h/m²", c: "500 m³/h/m²", d: "Aucune limite", correct: 'b', exp: "Filtrer plus vite = filtrer moins bien : les impuretés traversent le média et les crépines peuvent casser." },
  { cat: 'Filtration', q: "Charge type d'un filtre à sable :", a: "100% gravier", b: "Sable 0,4-0,8 mm sur un lit de gravier 2-4 mm qui protège les crépines", c: "Sable fin de plage", d: "Terre de diatomées pure", correct: 'b' },

  // ============================================================
  // DÉPANNAGE MATÉRIEL — complément fiches pompes
  // ============================================================
  { cat: 'Dépannage matériel', q: "Une pompe monophasée bourdonne à la mise sous tension mais ne démarre pas. Cause n°1 ?", a: "Le filtre est sale", b: "Le condensateur est mort", c: "Le pH est trop haut", d: "Le skimmer est bouché", correct: 'b' },
  { cat: 'Dépannage matériel', q: "Par quoi remplace-t-on un condensateur défectueux ?", a: "Un condensateur de capacité double", b: "Un condensateur de même capacité (tolérance ±5%)", c: "N'importe quel condensateur", d: "Un fusible", correct: 'b' },
  { cat: 'Dépannage matériel', q: "Avant de manipuler un condensateur, il faut :", a: "Le chauffer", b: "Le décharger en court-circuitant ses bornes avec un tournevis isolé", c: "Le plonger dans l'eau", d: "Rien de particulier", correct: 'b', exp: "Il peut conserver une charge dangereuse même hors tension." },
  { cat: 'Dépannage matériel', q: "Une fuite goutte à goutte entre le corps de pompe et le moteur signale :", a: "Un joint de couvercle sec", b: "Une garniture mécanique usée", c: "Un préfiltre plein", d: "Un excès de chlore", correct: 'b' },
  { cat: 'Dépannage matériel', q: "Dans le cas standard, une turbine de pompe se dévisse :", a: "Dans le sens horaire", b: "Dans le sens anti-horaire (le filetage est serré par la rotation du moteur)", c: "Elle ne se dévisse jamais", d: "Avec un marteau", correct: 'b', exp: "Le filetage inversé existe sur certains modèles : toujours vérifier la notice avant de forcer." },
  { cat: 'Dépannage matériel', q: "Un bruit de « cailloux » ou de graviers dans la pompe, préfiltre pourtant plein, signale :", a: "Une prise d'air", b: "De la cavitation", c: "Un roulement neuf", d: "Un excès de sel", correct: 'b' },
  { cat: 'Dépannage matériel', q: "Des bulles aux refoulements et un couvercle de préfiltre jamais complètement plein signalent :", a: "Une cavitation", b: "Une prise d'air à l'aspiration", c: "Un filtre trop propre", d: "Un TAC trop haut", correct: 'b' },
  { cat: 'Dépannage matériel', q: "Un moteur triphasé branché dans le mauvais sens de rotation :", a: "Ne démarre pas du tout", b: "Débite mal, souvent sans bruit anormal", c: "Disjoncte immédiatement", d: "Tourne normalement", correct: 'b', exp: "À vérifier systématiquement au branchement d'une pompe tri." },

  // ============================================================
  // CALCULS & FORMULES — complément dimensionnement
  // ============================================================
  { cat: 'Calculs & formules', q: "Loi d'affinité des pompes : si on divise la vitesse de rotation par 2, la puissance absorbée est divisée par :", a: "2", b: "4", c: "8", d: "16", correct: 'c', exp: "P ∝ N³ : c'est tout l'intérêt des pompes à vitesse variable (65-85% d'économies)." },
  { cat: 'Calculs & formules', q: "Comment calcule-t-on le débit de pompe requis pour une piscine ?", a: "Volume ÷ 2", b: "Volume ÷ 4 (recyclage en 4h), majoré d'environ 20% pour les pertes de charge", c: "Volume × 4", d: "Toujours 10 m³/h", correct: 'b' },
  { cat: 'Calculs & formules', q: "Quel débit maximal peut accepter un filtre Ø600 (0,28 m² de surface filtrante) ?", a: "~5 m³/h", b: "~14 m³/h", c: "~50 m³/h", d: "~100 m³/h", correct: 'b', exp: "Surface × 50 m³/h/m² : Ø500 → ~9,8 ; Ø600 → ~14 ; Ø750 → ~22 m³/h." },
  { cat: 'Calculs & formules', q: "Quelle vitesse d'eau maximale vise-t-on dans une canalisation d'aspiration ?", a: "0,1 m/s", b: "1,5 m/s", c: "5 m/s", d: "15 m/s", correct: 'b' },
  { cat: 'Calculs & formules', q: "Les pertes de charge d'une canalisation varient environ en :", a: "1/D (inverse du diamètre)", b: "1/D⁵ (inverse du diamètre à la puissance 5)", c: "D² (carré du diamètre)", d: "Elles ne dépendent pas du diamètre", correct: 'b', exp: "D'où la règle : mieux vaut un tuyau trop gros que trop petit." },

  // ============================================================
  // RÉGLEMENTATION & SÉCURITÉ — complément hydraulique et produits
  // ============================================================
  { cat: 'Réglementation & sécurité', q: "Quel équipement est obligatoire sur une bonde de fond pour prévenir le risque d'emprisonnement ?", a: "Un éclairage LED", b: "Une grille anti-vortex conforme (type XP P90-314)", c: "Un thermomètre", d: "Un skimmer supplémentaire", correct: 'b' },
  { cat: 'Réglementation & sécurité', q: "Quelle vitesse maximale de passage de l'eau vise-t-on à travers une grille d'aspiration ?", a: "0,5 m/s", b: "2 m/s", c: "5 m/s", d: "10 m/s", correct: 'a' },
  { cat: 'Réglementation & sécurité', q: "Pour les fortes aspirations, deux bondes de fond sur la même ligne doivent être espacées d'au moins :", a: "10 cm", b: "50 cm", c: "2 m (référentiel européen EN 16713-2)", d: "10 m", correct: 'c', exp: "Si l'une est obstruée par un corps, l'autre casse la dépression." },
  { cat: 'Réglementation & sécurité', q: "Le rejet sauvage des eaux de vidange dans la nature est sanctionné par :", a: "Aucun texte", b: "L'article L216-6 du Code de l'environnement (jusqu'à 2 ans et 75 000 € en cas de pollution)", c: "Une simple contravention de stationnement", d: "La norme NF P90-308", correct: 'b' },
  { cat: 'Réglementation & sécurité', q: "Après un collage de PVC pression, combien de temps attendre avant la mise en pression complète ?", a: "5 minutes", b: "1 heure", c: "24h minimum (48h par temps froid)", d: "1 semaine", correct: 'c' },
]
