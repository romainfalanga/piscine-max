...
4. Bloquer l'arbre (méplat côté ventilateur) et dévisser la turbine dans le sens anti-horaire (filetage standard, conçu pour que la rotation du moteur la serre). Attention : certains modèles ont un filetage inversé ou une vis centrale à pas inversé — toujours vérifier la notice avant de forcer.
...
7. Respecter le séchage avant mise en pression : 24h minimum avant la mise en pression complète du circuit, 48h par temps froid (moins de 10°C), avec une montée en pression progressive.`, tags: 'collage PVC, colle pression, décapant, raccord, fuite' },
...
Algues roses : en réalité des bactéries (et non de vraies algues), colonisent surtout les surfaces plastiques (liner, joints, paniers de skimmer), traitement bactéricide spécifique nécessaire en complément du chlore.`, tags: 'algues vertes, moutarde, noires, roses, identification' },
    { id: 38, owner: 1, by: 1, type: 'information', title: 'Comparatif des systèmes de filtration', category: 'Équipements', summary: 'Sable, cartouche, diatomées, verre : finesse et entretien.', content: `Sable : le plus répandu et économique, finesse de filtration 30-40 microns, entretien par backwash toutes les 1 à 2 semaines en saison (ou dès que la pression dépasse de 0,3-0,5 bar la référence), sable à remplacer tous les 5-7 ans.
...
HMT : Hauteur Manométrique Totale, capacité d'une pompe à vaincre les pertes de charge du circuit.`, tags: 'glossaire, vocabulaire, lexique, termes techniques' },
    { id: 51, owner: 3, by: 3, type: 'information', title: 'Premiers secours et prévention de la noyade', category: 'Réglementation & sécurité', summary: 'La noyade reste la 1ère cause de mort accidentelle chez les moins de 6 ans avec piscine.', content: `La noyade reste la première cause de mort accidentelle chez les enfants de moins de 6 ans en France disposant d'une piscine privée.
...
Les établissements sont classés en 4 types (A à D) selon leur nature et leur fréquentation, ce qui détermine la fréquence du contrôle sanitaire réalisé par un laboratoire agréé pour le compte de l'ARS (Agence Régionale de Santé) : environ 8 prélèvements par an pour les piscines de type A (les plus fréquentées), environ 4 par an pour le type B, et une fréquence réduite pouvant aller jusqu'à un contrôle annuel pour les plus petits établissements ; les établissements saisonniers (ouverture ≤ 6 mois) doivent être contrôlés au moins 2 fois par période d'ouverture.
...
Règle simplifiée couramment utilisée par les professionnels : environ 20 g de chlore choc par m³ pour un traitement standard — avec un produit à 60-70% de chlore actif, cela représente environ 12-14 ppm (mg/L) de chlore dans l'eau, un niveau curatif suffisant pour éliminer algues, bactéries et virus. Cette valeur est indicative : elle varie selon la concentration réelle du produit (hypochlorite de calcium 60-70% de chlore actif) indiquée sur l'emballage, de 5-15 g/m³ pour les produits très concentrés jusqu'à 30 g/m³ pour les moins concentrés — toujours vérifier l'étiquette avant de doser.
...
Le rejet sauvage dans la nature (cours d'eau, fossé) est interdit et pénalement sanctionné par l'article L216-6 du Code de l'environnement (jusqu'à 2 ans d'emprisonnement et 75 000 € d'amende en cas de pollution), complété par l'article L432-2 lorsque le rejet nuit au poisson.
...
Pourquoi c'est indispensable pour une PAC : l'échangeur titane a un débit optimal précis, souvent inférieur au débit total de filtration (trop peu de débit = défaut "flow" et arrêts ; trop de débit = pression excessive sur l'échangeur et ΔT trop faible pour la régulation, hors préconisations constructeur). Et l'isolement permet la maintenance et surtout la vidange de l'échangeur avant l'hiver — un échangeur qui gèle est détruit.
...
Double bonde : pour les fortes aspirations, deux bondes espacées d'au moins 2 m (référentiel européen EN 16713-2 ; la règle américaine VGB descend à ~0,9 m) raccordées sur la même ligne, chacune dimensionnée pour le débit total : si l'une est obstruée par un corps, l'autre casse la dépression.
